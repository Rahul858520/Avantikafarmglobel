  ...
  const missionPoints = [
    {
      ...
      desc: "Direct sourcing from trusted farmers to ensure freshness and fair trade.",
    },
    {
      icon: FaCheckCircle,
      title: "Strict Quality Protocols",
      desc: "Scientific grading and advanced optical sorting to guarantee export-grade produce.",
    },
    {
      icon: FaShieldAlt,
      title: "Safe & Compliant Exports",
      desc: "Adhering strictly to international phytosanitary and packaging standards.",
    },
    {
      icon: FaUserFriends,
      title: "Long-Term Buyer Relationships",
      desc: "Fostering trust through transparent communication and trial shipment flexibility.",
    },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-[#F8F5EC]/80 font-light">
            Guiding our journey from the fertile soils of India to supermarket
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          >
            ...
            <blockquote className="text-xl sm:text-2xl text-[#F8F5EC] font-medium italic leading-relaxed relative z-10">
              “To become a globally trusted Indian agri-export brand delivering
              premium-quality fresh produce with consistency and transparency.”
            </blockquote>
            <div className="mt-8 pt-8 border-t border-white/10 flex items-center gap-4">
              <div className="w-3 h-3 rounded-full bg-[#8BC34A] animate-ping" />
              <span className="text-sm font-bold text-[#8BC34A] uppercase tracking-wider">
                Global Excellence
              </span>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-8 pt-8 border-t border-white/10 flex items-center justify-between">
              <span className="text-xs sm:text-sm text-[#F8F5EC]/60 font-medium">
                Committed to sustainable agricultural global trade
              </span>
              <span className="text-xs font-bold text-[#8BC34A] uppercase tracking-widest bg-[#8BC34A]/10 px-3 py-1 rounded-full border border-[#8BC34A]/20">
                Est. 2026
              </span>
            </div>
          </motion.div>
